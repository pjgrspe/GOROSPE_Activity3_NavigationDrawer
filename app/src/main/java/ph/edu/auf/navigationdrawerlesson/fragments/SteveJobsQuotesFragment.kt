...
import ph.edu.auf.navigationdrawerlesson.databinding.FragmentSteveJobsQuotesBinding
...
class SteveJobsQuotesFragment : Fragment() {

    private var _binding: FragmentSteveJobsQuotesBinding? = null
    private val binding get() = _binding!!
    private lateinit var quotesGenerator: QuotesGenerator

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        _binding = FragmentSteveJobsQuotesBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        quotesGenerator = QuotesGenerator.generateSteveJobsQuotes().build()
